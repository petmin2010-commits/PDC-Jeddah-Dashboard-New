...
function renderEmergencyKpis(rows,root){
 ...
 const groups=[
   ...
   {title:'جودة واكتمال البيانات',tone:'quality',cards:[
     ...
     ['بدون تاريخ مباشرة العمل',rows.filter(r=>!filled(r,'startDate')).length,'العمود E — بيانات ناقصة'],
     ['بدون تاريخ انتهاء العمل',rows.filter(r=>!filled(r,'endDate')).length,'العمود F — بيانات ناقصة'],
